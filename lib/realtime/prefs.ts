...
export const NOTIFY_REASON_LABELS: Record<NotifyReason, string> = {
  ...
  document_triage: "Neuer Beleg zur Prüfung",
...
> = {
  ...
  mark_paid: "documents",
  document_triage: "documents",
  mail_triage: "documents",
  mail_calendar_patch: "documents",
  day_briefing: "documents",
  evening_digest: "documents",
  trip_comment: "travel",
