...
- Bank documents (Kontoauszug, Bankauszug, Depotauszug, Zins- und Kapitalausweis, Vermögensausweis, account/bank statement): set category «Steuern», set tax_year when the statement period year is known, extract bank_name and account_number (Kontonummer / IBAN / Kundenkonto as printed). Append the account number in parentheses at the end of short_summary, e.g. «Zins- und Kapitalausweis 2023 von CREDIT SUISSE (0020-16608-4A).»
...
- Bank docs (Kontoauszug, Zins-/Kapitalausweis, Depotauszug, …) → category «Steuern»; set bank_name + account_number; put account in short_summary as «(… )».
