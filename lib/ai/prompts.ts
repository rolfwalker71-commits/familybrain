...
- Bank documents (Kontoauszug, Bankauszug, Depotauszug, Zins- und Kapitalausweis, Vermögensausweis, account/bank statement): set category «Steuern», set tax_year when the statement period year is known, extract bank_name and account_number. Prefer the printed Kontonummer / Kundenkonto (e.g. 0020-16608-4A). If no Kontonummer is visible, use the IBAN instead. Append that value in parentheses at the end of short_summary, e.g. «Zins- und Kapitalausweis 2023 von CREDIT SUISSE (0020-16608-4A).» or «… (CH93 0076 2011 6238 5295 7).»
...
- Bank docs (Kontoauszug, Zins-/Kapitalausweis, Depotauszug, …) → category «Steuern»; set bank_name + account_number (Kontonummer preferred, else IBAN); put that value in short_summary as «(…)».
