...
- Bank documents (Kontoauszug, Bankauszug, Depotauszug, Zins- und Kapitalausweis, Vermögensausweis, account/bank statement) and credit-card statements (Kreditkartenabrechnung): set category «Steuern», set tax_year when the statement period year is known, extract bank_name and account_number. Priority for account_number: (1) printed Kontonummer / Kundenkonto, (2) Kartennummer (masked ok, e.g. •••• 1234), (3) IBAN only if no Kontonummer. Never put period dates into account_number. Append that value in parentheses at the end of short_summary, e.g. «Zins- und Kapitalausweis 2023 von CREDIT SUISSE (0020-16608-4A).», «Kontoauszug Raiffeisen (CH78 8080 8002 2500 9227 7).», or «Kreditkartenabrechnung Visa (•••• 4291).»
